...
RSpec.describe Agent::SessionsController, type: :controller do
  let(:valid_attributes) {
    { email: 'jackiechan@agent.com', password: 'password2', token: 'token2' }
  }

  let(:invalid_attributes) {
    { email: 'jackiechan@agent.com', password: 'password3_is_incorrect', token: 'token_is_incorrect' }
  }

  let(:email_not_found_attributes) {
    { email: 'this_email_is_not_exist@agent.com', password: 'will_be_skipped' }
  }
