...
ActiveRecord::Schema.define(version: 20161011102429) do
  ...
  create_table "administrators", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["token"], name: "index_administrators_on_token", using: :btree
  end
  ...
  create_table "agents", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["token"], name: "index_agents_on_token", using: :btree
  end
  ...
  create_table "customers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["token"], name: "index_customers_on_token", using: :btree
  end

  create_table "ticket_items", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "ticket_id"
    t.integer  "agent_id"
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["agent_id"], name: "index_ticket_items_on_agent_id", using: :btree
